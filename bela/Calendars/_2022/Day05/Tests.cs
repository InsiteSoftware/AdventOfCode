...
public class Tests
{
    ...
    {
        DoWork.FirstPart(basicInput).Should().Be("CMZ");
    }

    [Test]
    public void FileFirstPart()
    {
        DoWork.FirstPart(fileInput).Should().Be("NTWZZWHFV");
    }

    [Test]
    public void BasicSecondPart()
    {
        DoWork.SecondPart(basicInput).Should().Be("MCD");
    }

    [Test]
    public void FileSecondPart()
    {
        DoWork.SecondPart(fileInput).Should().Be("BRZGFVBTJ");
    }
