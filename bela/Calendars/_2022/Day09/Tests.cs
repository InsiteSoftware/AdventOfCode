...
public class Tests
{
    ...
    {
        DoWork.FirstPart(basicInput).Should().Be(13);
    }

    [Test]
    public void FileFirstPart()
    {
        DoWork.FirstPart(fileInput).Should().Be(6494);
    }

    [Test]
    public void BasicSecondPart()
    {
        DoWork.SecondPart(basicInput).Should().Be(1);
    }

    [Test]
    public void BiggerSecondPart()
    {
        DoWork
            .SecondPart(
                @"R 5
...
U 20"
    ...
    {
        // 2479 is TOO LOW!!!!
        DoWork.SecondPart(fileInput).Should().Be(2691);
    }
