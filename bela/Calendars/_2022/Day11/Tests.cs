...
public class Tests
{
    ...
    {
        DoWork.FirstPart(basicInput).Should().Be(10605);
    }

    [Test]
    public void FileFirstPart()
    {
        DoWork.FirstPart(fileInput).Should().Be(101436);
    }

    [Test]
    public void BasicSecondPart()
    {
        DoWork.SecondPart(basicInput).Should().Be(2713310158);
    }

    [Test]
    public void FileSecondPart()
    {
        DoWork.SecondPart(fileInput).Should().Be(19754471646);
    }
